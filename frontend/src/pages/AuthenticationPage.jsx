...
const AuthenticationPage = ({ mode, role }) => {
    const getBgImage = () => {
        switch (role) {
            case "Seller":
                return "https://www.rootsdigital.com.sg/wp-content/uploads/2022/03/E-commerce-Hero-Illustration.png";
            case "Customer":
                return "https://i.pinimg.com/originals/7a/61/f7/7a61f70b45d46e357014215eb710030c.png";
            default:
                return "https://images.pexels.com/photos/1121097/pexels-photo-1121097.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
        }
    };
