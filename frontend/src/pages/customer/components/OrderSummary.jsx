                    ...
                    <List disablePadding>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                {`TND${productDetailsCart.price && productDetailsCart.price.mrp * productDetailsCart.quantity}`}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            <ListItemText primary="Discount" />
                            <Typography variant="subtitle1" sx={{ color: "green" }}>
                                TND {productDetailsCart.price && productDetailsCart.price.mrp - productDetailsCart.price.cost}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                        ...
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                TND {productDetailsCart.price && productDetailsCart.price.cost * productDetailsCart.quantity}
                            </Typography>
                        </ListItem>
                    </List>
                    ...
                    <List disablePadding>
                        {cartDetails.map((product, index) => (
                            <ListItem key={index} sx={{ py: 1, px: 0 }}>
                                ...
                                <Typography variant="body2">{`TND${product.quantity * product.price.mrp}`}</Typography>
                            </ListItem>
                        ))}
                        <ListItem sx={{ py: 1, px: 0 }}>
                        ...
                        <ListItem sx={{ py: 1, px: 0 }}>
                            <ListItemText primary="Discount" />
                            <Typography variant="subtitle1" sx={{ color: "green" }}>
                                TND {totalOGPrice - totalNewPrice}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            <ListItemText primary="Shipping" />
